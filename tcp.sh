...
#	Version: 1.4.0
#	Author: 千影,cx9208,wulabing
#	Blog: https://www.94ish.me/
#=================================================

sh_ver="1.4.0"
github="raw.githubusercontent.com/wulabing/Linux-NetSpeed/master"
...
#安装BBRplus内核
installbbrplus(){
	kernel_version="4.14.161-bbrplus"
	if [[ "${release}" == "centos" ]]; then
		wget -N --no-check-certificate https://${github}/bbrplus/${release}/${version}/kernel-${kernel_version}.rpm
		yum install -y kernel-${kernel_version}.rpm
		rm -f kernel-${kernel_version}.rpm
		kernel_version="4.14.161_bbrplus" #fix a bug
	elif [[ "${release}" == "debian" || "${release}" == "ubuntu" ]]; then
...
check_status(){
	...
	if [[ ${kernel_version_full} = "4.14.161-bbrplus" ]]; then
